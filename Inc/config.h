...
#define BAT_CALIB_REAL_VOLTAGE  3620  //3970    // input voltage measured by multimeter (multiplied by 100). In this case 43.00 V * 100 = 4300
...
#define BAT_DEAD_ENABLE         0//1         // to poweroff or not to poweroff, 1 or 0
